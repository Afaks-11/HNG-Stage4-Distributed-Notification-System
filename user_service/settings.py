...
This service manages user contact info (email, push tokens),
notification preferences, login, and permissions.
"""
...
# Redis configuration (for caching and future use)
